//
//  GRichTextAttributedLabelAttachment.m
...
{
    GRichTextAttributedLabelAttachment *image = (__bridge GRichTextAttributedLabelAttachment *)ref;
    CGFloat ascent = 0;
...
#pragma mark - RichTextAttributedLabelImage
@interface GRichTextAttributedLabelAttachment ()
- (CGSize)calculateContentSize;
- (CGSize)attachmentSize;
@end

@implementation GRichTextAttributedLabelAttachment

+ (GRichTextAttributedLabelAttachment *)attachmentWith:(id)content
                                          margin:(UIEdgeInsets)margin
                                       alignment:(RichTextImageAlignment)alignment
                                         maxSize:(CGSize)maxSize {
    GRichTextAttributedLabelAttachment *attachment    = [[GRichTextAttributedLabelAttachment alloc]init];
